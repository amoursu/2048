...
public class GameView extends GridLayout {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Config.CARD_WIDTH = (Math.min(w, h)-30)/Config.LINES;
    ...
    public void startGame(){
        ...
        MyActivity aty = MyActivity.getMainActivity();
        aty.clearScore();
    ...
    private void addRandomNum(){
        ...
        if (emptyPoints.size()>0) {
            ...
            MyActivity.getMainActivity().getAnimLayer().createScaleTo1(cardsMap[p.x][p.y]);
        }
    }
                ...
                for (int x1 = x+1; x1 < Config.LINES; x1++) {
                    if (cardsMap[x1][y].getNum()>0) {
                        ...
                        if (cardsMap[x][y].getNum()<=0) {
                            ...
                            MyActivity.getMainActivity().getAnimLayer().createMoveAnim(cardsMap[x1][y],cardsMap[x][y], x1, x, y, y);
                            ...
                            MyActivity.getMainActivity().addScore(cardsMap[x][y].getNum());
                            merge = true;
                        }
                        break;
                    }
            ...
            for (int y = 0; y < Config.LINES; y++) {
                ...
                for (int y1 = y+1; y1 < Config.LINES; y1++) {
                    if (cardsMap[x][y1].getNum()>0) {
                        ...
                        if (cardsMap[x][y].getNum()<=0) {
                            MyActivity.getMainActivity().getAnimLayer().createMoveAnim(cardsMap[x][y1],cardsMap[x][y], x, x, y1, y);
